...
Original file is located at
    https://colab.research.google.com/drive/1V1JxrKcXKTckbPNa57Ud4qmMJoebweXa
"""

import stremalit as sm
import os
...
def onchange_selectbox():
  st.session_state.message = []

if not st.user.is_logged_in:
  # message to please login with an icon
    st.markdown("⚠️ Please login to access the chat assistant")
    st.stop()
